...
const JobsView = ({ accNo, costCenter, resource, jobremarks, first_name, last_name, user_id,IOU_Type, status, date, approved_status, amount, user_avatar, request_type, currency_type, request_channel, employee_no, job_no, expense_type, remarks, employee_name, right, selectedItems, requestDate }: ParamTypes) => {
    return (
        <SafeAreaView>
